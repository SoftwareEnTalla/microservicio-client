...
import { CreateClientSegmentCommand } from "../createclientsegment.command";
...
@CommandHandler(CreateClientSegmentCommand)
export class CreateClientSegmentHandler
  implements ICommandHandler<CreateClientSegmentCommand>
{
  constructor(
  ...
  async execute(command: CreateClientSegmentCommand) {
