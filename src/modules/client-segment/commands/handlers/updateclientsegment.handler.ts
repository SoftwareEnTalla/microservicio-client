...
import { UpdateClientSegmentCommand } from "../updateclientsegment.command";
...
export class UpdateClientSegmentHandler
  implements ICommandHandler<UpdateClientSegmentCommand>
{
  ...
  async execute(command: UpdateClientSegmentCommand) {
