...
@Module({
  controllers: [ClientSegmentCommandController],
  providers: [
  ...
  exports: [ClientSegmentAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthClientSegmentModule {}
