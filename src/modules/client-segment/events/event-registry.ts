...
import { ClientSegmentCreatedEvent } from './clientsegmentcreated.event';
import { ClientSegmentUpdatedEvent } from './clientsegmentupdated.event';
import { ClientSegmentDeletedEvent } from './clientsegmentdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'client-segment-created': createEventDefinition('client-segment-created', ClientSegmentCreatedEvent, EVENT_DEFINITION_OVERRIDES['client-segment-created']),
  'client-segment-updated': createEventDefinition('client-segment-updated', ClientSegmentUpdatedEvent, EVENT_DEFINITION_OVERRIDES['client-segment-updated']),
  'client-segment-deleted': createEventDefinition('client-segment-deleted', ClientSegmentDeletedEvent, EVENT_DEFINITION_OVERRIDES['client-segment-deleted']),
