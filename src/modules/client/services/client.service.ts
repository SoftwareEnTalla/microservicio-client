...
export class ClientService {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Client[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Client[]> {
  ...
  async update(id: string, partialEntity: Partial<Client>): Promise<Client | null> {
