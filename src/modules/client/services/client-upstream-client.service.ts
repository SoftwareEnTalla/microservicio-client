 ...
 * y timeout configurable. Permite que Client opere en modo LOCAL_ONLY
...
@Injectable()
export class ClientUpstreamClientService {
  private readonly logger = new Logger(ClientUpstreamClientService.name);
