...
@Entity('client_base_entity')  // 🔹 Necesario para que TypeORM la registre como entidad
...
export abstract class BaseEntity {
  ...
  @ApiProperty({
      type: String,
      nullable: false,
      description: "Columna discriminadora de la instancia de Client",
  })
  @Field(() => String, { description: "🔹 Columna discriminadora de la instancia de Client", nullable: false })
  @Column({ type: 'varchar', length: 100, nullable: false,comment: 'Este es para discriminar en las instancias de Client' })
  @IsString()
  @IsOptional()
  type!: string;
  ...
  @Column({ type: 'varchar', length: 100, nullable: false,comment: 'Este es un campo del creador de la instancia de Client' })
  @IsString()
  @IsOptional()
  ...
  @Column({ type: 'boolean', nullable: false,comment: 'Campo para muestrar si la instancia de Client está activa o no' })
  @IsBoolean()
