...
export class DeleteClientDto {
  ...
  // Propiedades predeterminadas de la clase DeleteClientDto según especificación del sistema
  ...
  static build(data: Partial<DeleteClientDto>): DeleteClientDto {
    const instance = new DeleteClientDto(data);
