...
import { CreateClientTypeCommand } from "../createclienttype.command";
...
@CommandHandler(CreateClientTypeCommand)
export class CreateClientTypeHandler
  implements ICommandHandler<CreateClientTypeCommand>
{
  constructor(
  ...
  async execute(command: CreateClientTypeCommand) {
