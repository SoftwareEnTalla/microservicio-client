...
@Module({
  controllers: [ClientLoyaltyTierCommandController],
  providers: [
  ...
  exports: [ClientLoyaltyTierAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthClientLoyaltyTierModule {}
