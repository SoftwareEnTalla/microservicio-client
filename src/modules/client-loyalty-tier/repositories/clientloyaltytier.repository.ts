...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class ClientLoyaltyTierRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[ClientLoyaltyTier[], number]> {
      logger.info('Ready to findByField ClientLoyaltyTier on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of ClientLoyaltyTier with id:  was finded on repository:', instance);
